...
class CriticNetwork(nn.Module):
    ...
    def __init__(self, input_dims, n_actions, fc1_dims=256, fc2_dims=128, name='critic', checkpoint_dir='tmp/td3',  learning_rate=1e-3):
        ...
        print(f"Critic Network using device: {self.device}")
...
class ActorNetwork(nn.Module):
    ...
    def __init__(self, input_dims, fc1_dims=256, fc2_dims=128, learning_rate=1e-3,  n_actions=2, name='actor', checkpoint_dir='tmp/td3'):
        ...
        print(f"Actor Network using device: {self.device}")
